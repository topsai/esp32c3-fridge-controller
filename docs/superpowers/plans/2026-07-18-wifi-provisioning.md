...
- [ ] **Step 1: Extend the repository policy test and verify RED**
...
- [ ] **Step 2: Add the fixed dependency and manager**
...
- [ ] **Step 3: Implement boot and retry behavior**
...
- [ ] **Step 4: Implement manual reset behavior**
...
- [ ] **Step 1: Add a source-policy assertion and verify RED**
...
- [ ] **Step 2: Refactor OTA connection handling**
...
- [ ] **Step 3: Update compatibility documentation and verify GREEN**
...
- [ ] **Step 1: Extend Python/source regressions and verify RED**
...
- [ ] **Step 2: Integrate startup and loop polling**
...
- [ ] **Step 4: Add safe HIL telemetry and verify GREEN**
...
- [ ] **Step 1: Complete user and troubleshooting documentation**
...
- [ ] **Step 3: Clean-build all environments and check partition margin**
